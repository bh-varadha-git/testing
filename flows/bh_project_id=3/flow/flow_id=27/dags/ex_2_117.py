...
common_task = CommonTask(dag_id='ex_2_117', dag_params={})
lineage_task = LineageTask(dag_id='ex_2_117', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_overview_117_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=748/sample_p_d0284_algc26_rp_d260313_t1532354_overview_117.json",
                "databricks",
    ...
    run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_overview_117 = PythonOperator(
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=749/sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
    ...
    run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_overview_117 >> run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117
    ...
    create_compute >> [run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_overview_117, run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117]
    run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_overview_117 >> delete_compute
    run_jobs_sample_p_d0284_algc26_rp_d260313_t1532354_monthly_data_117 >> delete_compute
