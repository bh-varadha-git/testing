...
common_task = CommonTask(dag_id='ex_5_125', dag_params={})
lineage_task = LineageTask(dag_id='ex_5_125', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_ex_5_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=750/ex_5.json",
                "databricks",
    ...
    run_jobs_ex_5 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_ex_5',
    ...
    create_compute >> [run_jobs_ex_5]
    run_jobs_ex_5 >> delete_compute
