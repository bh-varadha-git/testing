...
common_task = CommonTask(dag_id='ig02_51', dag_params={})
lineage_task = LineageTask(dag_id='ig02_51', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_level_01_section_1_and_1_1_51_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=713/level_01_section_1_and_1_1_51.json",
                "databricks",
    ...
    run_jobs_level_01_section_1_and_1_1_51 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_level_01_section_1_and_1_1_51',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_level_04_section_4_51_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=714/level_04_section_4_51.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_level_04_section_4_51 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_level_04_section_4_51',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_level_07_section_4_51_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=715/level_07_section_4_51.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_level_07_section_4_51 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_level_07_section_4_51',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_level_11_section_4_51_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=716/level_11_section_4_51.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_level_11_section_4_51 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_level_11_section_4_51',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    create_compute >> [run_jobs_level_01_section_1_and_1_1_51, run_jobs_level_04_section_4_51, run_jobs_level_07_section_4_51]
    run_jobs_level_11_section_4_51 >> delete_compute
    run_jobs_level_01_section_1_and_1_1_51 >> run_jobs_level_11_section_4_51
    run_jobs_level_04_section_4_51 >> run_jobs_level_11_section_4_51
    run_jobs_level_07_section_4_51 >> run_jobs_level_11_section_4_51
