...
common_task = CommonTask(dag_id='in1_99', dag_params={})
lineage_task = LineageTask(dag_id='in1_99', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_explanationofbenefit_ndjson_99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=743/explanationofbenefit_ndjson_99.json",
                "databricks",
    ...
    run_jobs_explanationofbenefit_ndjson_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_explanationofbenefit_ndjson_99',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_patient_ndjson_99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=744/patient_ndjson_99.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_patient_ndjson_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_patient_ndjson_99',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_coverage_ndjson_99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=742/coverage_ndjson_99.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_coverage_ndjson_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_coverage_ndjson_99',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    run_jobs_explanationofbenefit_ndjson_99 >> run_jobs_patient_ndjson_99
    run_jobs_patient_ndjson_99 >> run_jobs_coverage_ndjson_99
    ...
    create_compute >> [run_jobs_explanationofbenefit_ndjson_99, run_jobs_patient_ndjson_99, run_jobs_coverage_ndjson_99]
    run_jobs_explanationofbenefit_ndjson_99 >> delete_compute
    run_jobs_patient_ndjson_99 >> delete_compute
    run_jobs_coverage_ndjson_99 >> delete_compute
