...
common_task = CommonTask(dag_id='ndjson_2_114', dag_params={})
lineage_task = LineageTask(dag_id='ndjson_2_114', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 26,
            'flow_name': 'ndjson_2_114',
            'flow_key': 'ndjson_2_114',
            'bh_project_id': 3,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_coverage_ndjson_114_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=745/coverage_ndjson_114.json",
                "databricks",
    ...
    run_jobs_coverage_ndjson_114 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_coverage_ndjson_114',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_explanationofbenefit_ndjson_114_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=746/explanationofbenefit_ndjson_114.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_explanationofbenefit_ndjson_114 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_explanationofbenefit_ndjson_114',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_patient_ndjson_114_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/bh-dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=747/patient_ndjson_114.json",
                "databricks",
                "/Workspace/Shared/bh-dev-utils/schemas"
            ]
        },
    ...
    run_jobs_patient_ndjson_114 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_patient_ndjson_114',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        provide_context=True,
        on_success_callback=common_task.success_callback,
    ...
    run_jobs_coverage_ndjson_114 >> run_jobs_explanationofbenefit_ndjson_114
    run_jobs_explanationofbenefit_ndjson_114 >> run_jobs_patient_ndjson_114
    ...
    create_compute >> [run_jobs_coverage_ndjson_114, run_jobs_explanationofbenefit_ndjson_114, run_jobs_patient_ndjson_114]
    run_jobs_coverage_ndjson_114 >> delete_compute
    run_jobs_explanationofbenefit_ndjson_114 >> delete_compute
    run_jobs_patient_ndjson_114 >> delete_compute
