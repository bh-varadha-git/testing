...
common_task = CommonTask(dag_id='022_date_aliases_and_timestamps_204_194', dag_params={})
lineage_task = LineageTask(dag_id='022_date_aliases_and_timestamps_204_194', dag_params={})
...
with DAG(
    dag_id='022_date_aliases_and_timestamps_204_194',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 194,
            'flow_name': '022_date_aliases_and_timestamps_204',
            'flow_key': '022_date_aliases_and_timestamps_204',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _validate_params = {
        ...
        "source_prefix": "healthcare_demo/data2/022_date_aliases_and_timestamps",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "healthcare_demo/data2/022_date_aliases_and_timestamps/rejected",
        "fail_on_invalid": True,
        "use_valid_files_manifest": False,
        "runtime_params_base_path": "/Workspace/Shared/runtime_params",
        "sources": [
            {
                "source_name": "roster_20260904",
                "prefix": "healthcare_demo/data2/022_date_aliases_and_timestamps",
                "filename_regex": "roster_20260904.csv",
        ...
        "control_schema": None,
        "feed_name": "022_date_aliases_and_timestamps",
        "feed_id": "022_date_aliases_and_timestamps"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_roster_20260904_204_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1276/roster_20260904_204.json",
                "databricks",
        ...
        "pipeline_name": "roster_20260904_204",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "roster_20260904_204",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_roster_20260904_204 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_roster_20260904_204',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/healthcare_demo/data2/022_date_aliases_and_timestamps",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azurebloblocal",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_roster_20260904_204
    run_pipelines_roster_20260904_204 >> archive_processed_files
