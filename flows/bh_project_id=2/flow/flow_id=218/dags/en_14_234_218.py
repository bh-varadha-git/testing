...
common_task = CommonTask(dag_id='en_14_234_218', dag_params={})
lineage_task = LineageTask(dag_id='en_14_234_218', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_data_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1767/data_234.json",
                "databricks",
        ...
        "pipeline_name": "data_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_data_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_234',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_data_1_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1768/data_1_234.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "data_1_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_1_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_data_1_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_1_234',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_legacyauditlogcr_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1769/legacyauditlogcr_234.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "legacyauditlogcr_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "legacyauditlogcr_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_legacyauditlogcr_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_legacyauditlogcr_234',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_muthusheet_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1770/muthusheet_234.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "muthusheet_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "muthusheet_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_muthusheet_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_muthusheet_234',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_unixstagingconfiglf_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1771/unixstagingconfiglf_234.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "unixstagingconfiglf_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "unixstagingconfiglf_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_unixstagingconfiglf_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_unixstagingconfiglf_234',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_windowsorderscrlf_234_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1772/windowsorderscrlf_234.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "windowsorderscrlf_234",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "windowsorderscrlf_234",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_windowsorderscrlf_234 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_windowsorderscrlf_234',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_data_234
    run_pipelines_data_234 >> run_pipelines_data_1_234
    create_compute >> run_pipelines_data_1_234
    run_pipelines_data_1_234 >> run_pipelines_legacyauditlogcr_234
    create_compute >> run_pipelines_legacyauditlogcr_234
    run_pipelines_legacyauditlogcr_234 >> run_pipelines_muthusheet_234
    create_compute >> run_pipelines_muthusheet_234
    run_pipelines_muthusheet_234 >> run_pipelines_unixstagingconfiglf_234
    create_compute >> run_pipelines_unixstagingconfiglf_234
    run_pipelines_unixstagingconfiglf_234 >> run_pipelines_windowsorderscrlf_234
    create_compute >> run_pipelines_windowsorderscrlf_234
    run_pipelines_windowsorderscrlf_234 >> archive_processed_files
