...
common_task = CommonTask(dag_id='en_15_235_219', dag_params={})
lineage_task = LineageTask(dag_id='en_15_235_219', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_data_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1773/data_235.json",
                "databricks",
        ...
        "pipeline_name": "data_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_data_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_235',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_data_1_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1774/data_1_235.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "data_1_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_1_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_data_1_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_1_235',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_legacyauditlogcr_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1775/legacyauditlogcr_235.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "legacyauditlogcr_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "legacyauditlogcr_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_legacyauditlogcr_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_legacyauditlogcr_235',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_muthusheet_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1776/muthusheet_235.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "muthusheet_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "muthusheet_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_muthusheet_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_muthusheet_235',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_unixstagingconfiglf_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1777/unixstagingconfiglf_235.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "unixstagingconfiglf_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "unixstagingconfiglf_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_unixstagingconfiglf_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_unixstagingconfiglf_235',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_windowsorderscrlf_235_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1778/windowsorderscrlf_235.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "windowsorderscrlf_235",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "windowsorderscrlf_235",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_windowsorderscrlf_235 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_windowsorderscrlf_235',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_data_235
    run_pipelines_data_235 >> run_pipelines_data_1_235
    create_compute >> run_pipelines_data_1_235
    run_pipelines_data_1_235 >> run_pipelines_legacyauditlogcr_235
    create_compute >> run_pipelines_legacyauditlogcr_235
    run_pipelines_legacyauditlogcr_235 >> run_pipelines_muthusheet_235
    create_compute >> run_pipelines_muthusheet_235
    run_pipelines_muthusheet_235 >> run_pipelines_unixstagingconfiglf_235
    create_compute >> run_pipelines_unixstagingconfiglf_235
    run_pipelines_unixstagingconfiglf_235 >> run_pipelines_windowsorderscrlf_235
    create_compute >> run_pipelines_windowsorderscrlf_235
    run_pipelines_windowsorderscrlf_235 >> archive_processed_files
