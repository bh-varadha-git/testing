...
common_task = CommonTask(dag_id='local_29_88_75', dag_params={})
lineage_task = LineageTask(dag_id='local_29_88_75', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 75,
            'flow_name': 'local_29_88',
            'flow_key': 'local_29_88',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_local_29_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=227/local_29.json",
                "databricks",
    ...
    run_pipelines_local_29 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_local_29',
    ...
    create_compute >> run_pipelines_local_29
    run_pipelines_local_29 >> archive_processed_files
