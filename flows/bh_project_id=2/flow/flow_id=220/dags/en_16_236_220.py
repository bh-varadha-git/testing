...
common_task = CommonTask(dag_id='en_16_236_220', dag_params={})
lineage_task = LineageTask(dag_id='en_16_236_220', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_data_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1779/data_236.json",
                "databricks",
        ...
        "pipeline_name": "data_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_data_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_236',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_data_1_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1780/data_1_236.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "data_1_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_1_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_data_1_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_1_236',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_legacyauditlogcr_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1781/legacyauditlogcr_236.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "legacyauditlogcr_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "legacyauditlogcr_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_legacyauditlogcr_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_legacyauditlogcr_236',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_muthusheet_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1782/muthusheet_236.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "muthusheet_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "muthusheet_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_muthusheet_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_muthusheet_236',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_unixstagingconfiglf_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1783/unixstagingconfiglf_236.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "unixstagingconfiglf_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "unixstagingconfiglf_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_unixstagingconfiglf_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_unixstagingconfiglf_236',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_windowsorderscrlf_236_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1784/windowsorderscrlf_236.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "windowsorderscrlf_236",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "windowsorderscrlf_236",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_windowsorderscrlf_236 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_windowsorderscrlf_236',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_data_236
    run_pipelines_data_236 >> run_pipelines_data_1_236
    create_compute >> run_pipelines_data_1_236
    run_pipelines_data_1_236 >> run_pipelines_legacyauditlogcr_236
    create_compute >> run_pipelines_legacyauditlogcr_236
    run_pipelines_legacyauditlogcr_236 >> run_pipelines_muthusheet_236
    create_compute >> run_pipelines_muthusheet_236
    run_pipelines_muthusheet_236 >> run_pipelines_unixstagingconfiglf_236
    create_compute >> run_pipelines_unixstagingconfiglf_236
    run_pipelines_unixstagingconfiglf_236 >> run_pipelines_windowsorderscrlf_236
    create_compute >> run_pipelines_windowsorderscrlf_236
    run_pipelines_windowsorderscrlf_236 >> archive_processed_files
