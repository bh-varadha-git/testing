...
common_task = CommonTask(dag_id='026_date_aliases_and_timestamps_199_189', dag_params={})
lineage_task = LineageTask(dag_id='026_date_aliases_and_timestamps_199_189', dag_params={})
...
with DAG(
    dag_id='026_date_aliases_and_timestamps_199_189',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 189,
            'flow_name': '026_date_aliases_and_timestamps_199',
            'flow_key': '026_date_aliases_and_timestamps_199',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_roster_20260908_199_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1271/roster_20260908_199.json",
                "databricks",
    ...
    run_pipelines_roster_20260908_199 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_roster_20260908_199',
    ...
    create_compute >> run_pipelines_roster_20260908_199
    run_pipelines_roster_20260908_199 >> archive_processed_files
