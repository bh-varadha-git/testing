...
common_task = CommonTask(dag_id='bp_onboard_33cd8179_176_185', dag_params={})
lineage_task = LineageTask(dag_id='bp_onboard_33cd8179_176_185', dag_params={})
...
with DAG(
    dag_id='bp_onboard_33cd8179_176_185',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 185,
            'flow_name': 'bp_onboard_33cd8179_176',
            'flow_key': 'bp_onboard_33cd8179_176',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_roster_20260902_176_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1256/roster_20260902_176.json",
                "databricks",
        ...
        "pipeline_name": "roster_20260902_176",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "roster_20260902_176",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_roster_20260902_176 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_roster_20260902_176',
    ...
    create_compute >> run_pipelines_roster_20260902_176
    run_pipelines_roster_20260902_176 >> archive_processed_files
