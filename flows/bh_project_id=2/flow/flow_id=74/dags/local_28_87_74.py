...
common_task = CommonTask(dag_id='local_28_87_74', dag_params={})
lineage_task = LineageTask(dag_id='local_28_87_74', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 74,
            'flow_name': 'local_28_87',
            'flow_key': 'local_28_87',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_local_28_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=226/local_28.json",
                "databricks",
    ...
    run_pipelines_local_28 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_local_28',
    ...
    create_compute >> run_pipelines_local_28
    run_pipelines_local_28 >> archive_processed_files
