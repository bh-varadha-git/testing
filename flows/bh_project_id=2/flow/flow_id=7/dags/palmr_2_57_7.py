...
common_task = CommonTask(dag_id='palmr_2_57_7', dag_params={})
lineage_task = LineageTask(dag_id='palmr_2_57_7', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_palmr_2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=57/palmr_2.json",
                "databricks",
    ...
    run_pipelines_palmr_2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_palmr_2',
    ...
    create_compute >> run_pipelines_palmr_2
    run_pipelines_palmr_2 >> archive_processed_files
