...
common_task = CommonTask(dag_id='011_date_of_birth_as_string_203_193', dag_params={})
lineage_task = LineageTask(dag_id='011_date_of_birth_as_string_203_193', dag_params={})
...
with DAG(
    dag_id='011_date_of_birth_as_string_203_193',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 193,
            'flow_name': '011_date_of_birth_as_string_203',
            'flow_key': '011_date_of_birth_as_string_203',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _validate_params = {
        ...
        "source_prefix": "healthcare_demo/data2/011_date_of_birth_as_string",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "healthcare_demo/data2/011_date_of_birth_as_string/rejected",
        "fail_on_invalid": True,
        "use_valid_files_manifest": False,
        "runtime_params_base_path": "/Workspace/Shared/runtime_params",
        "sources": [
            {
                "source_name": "members_20260904",
                "prefix": "healthcare_demo/data2/011_date_of_birth_as_string",
                "filename_regex": "members_20260904.csv",
        ...
        "control_schema": None,
        "feed_name": "011_date_of_birth_as_string",
        "feed_id": "011_date_of_birth_as_string"
    }
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_members_20260904_203_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1275/members_20260904_203.json",
                "databricks",
        ...
        "pipeline_name": "members_20260904_203",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "members_20260904_203",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_members_20260904_203 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_members_20260904_203',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/healthcare_demo/data2/011_date_of_birth_as_string",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azurebloblocal",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_members_20260904_203
    run_pipelines_members_20260904_203 >> archive_processed_files
