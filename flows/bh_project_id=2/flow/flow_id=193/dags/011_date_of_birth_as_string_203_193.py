...
with DAG(
        ...
        "sources": [
            {
                ...
                "filename_regex": "^members_[0-9]{8}[.]csv$",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_members_203_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1765/members_203.json",
                "databricks",
        ...
        "pipeline_name": "members_203",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "members_203",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_members_203 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_members_203',
    ...
    create_compute >> run_pipelines_members_203
    run_pipelines_members_203 >> archive_processed_files
