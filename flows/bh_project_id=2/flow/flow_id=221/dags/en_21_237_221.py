...
common_task = CommonTask(dag_id='en_21_237_221', dag_params={})
lineage_task = LineageTask(dag_id='en_21_237_221', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_data_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1789/data_237.json",
                "databricks",
        ...
        "pipeline_name": "data_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_data_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_237',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_data_1_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1790/data_1_237.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "data_1_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "data_1_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_data_1_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_data_1_237',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_legacyauditlogcr_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1791/legacyauditlogcr_237.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "legacyauditlogcr_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "legacyauditlogcr_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_legacyauditlogcr_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_legacyauditlogcr_237',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_muthusheet_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1792/muthusheet_237.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "muthusheet_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "muthusheet_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_muthusheet_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_muthusheet_237',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_unixstagingconfiglf_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1793/unixstagingconfiglf_237.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "unixstagingconfiglf_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "unixstagingconfiglf_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_unixstagingconfiglf_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_unixstagingconfiglf_237',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_windowsorderscrlf_237_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1794/windowsorderscrlf_237.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "windowsorderscrlf_237",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "windowsorderscrlf_237",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
        "compute_xcom_key": "return_value",
    ...
    run_pipelines_windowsorderscrlf_237 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_windowsorderscrlf_237',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_data_237
    run_pipelines_data_237 >> run_pipelines_data_1_237
    create_compute >> run_pipelines_data_1_237
    run_pipelines_data_1_237 >> run_pipelines_legacyauditlogcr_237
    create_compute >> run_pipelines_legacyauditlogcr_237
    run_pipelines_legacyauditlogcr_237 >> run_pipelines_muthusheet_237
    create_compute >> run_pipelines_muthusheet_237
    run_pipelines_muthusheet_237 >> run_pipelines_unixstagingconfiglf_237
    create_compute >> run_pipelines_unixstagingconfiglf_237
    run_pipelines_unixstagingconfiglf_237 >> run_pipelines_windowsorderscrlf_237
    create_compute >> run_pipelines_windowsorderscrlf_237
    run_pipelines_windowsorderscrlf_237 >> archive_processed_files
