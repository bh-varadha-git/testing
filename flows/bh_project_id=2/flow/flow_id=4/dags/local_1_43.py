...
common_task = CommonTask(dag_id='local_1_43', dag_params={})
lineage_task = LineageTask(dag_id='local_1_43', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_local_1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=21/local_1.json",
                "databricks",
    ...
    run_pipelines_local_1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_local_1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=22/silver_raw_source_to_local_test_load_260520_9d0a.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_local_1
    run_pipelines_local_1 >> run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a
    create_compute >> run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a
    run_pipelines_silver_raw_source_to_local_test_load_260520_9d0a >> archive_processed_files
