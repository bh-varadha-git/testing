...
common_task = CommonTask(dag_id='en_12_213_195', dag_params={})
lineage_task = LineageTask(dag_id='en_12_213_195', dag_params={})
...
with DAG(
    ...
    _validate_params = {
        ...
        "source_prefix": "optum_date_issue",
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "optum_date_issue/rejected",
        "fail_on_invalid": True,
        "use_valid_files_manifest": False,
        "runtime_params_base_path": "/Workspace/Shared/runtime_params",
        "sources": [
            {
                "source_name": "testdates",
                "prefix": "optum_date_issue",
                "filename_regex": "^test_dates[.]csv$",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_testdates_213_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1298/testdates_213.json",
                "databricks",
        ...
        "pipeline_name": "testdates_213",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "testdates_213",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_testdates_213 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_testdates_213',
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/optum_date_issue",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azurebloblocal",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_testdates_213
    run_pipelines_testdates_213 >> archive_processed_files
