...
common_task = CommonTask(dag_id='sv_enroll_19may_2_42', dag_params={})
lineage_task = LineageTask(dag_id='sv_enroll_19may_2_42', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 3,
            'flow_name': 'sv_enroll_19may_2_42',
            'flow_key': 'sv_enroll_19may_2_42',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_cenetegarisk_enrollment_server_2_42_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=19/cenetegarisk_enrollment_server_2_42.json",
                "databricks",
    ...
    run_pipelines_cenetegarisk_enrollment_server_2_42 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_cenetegarisk_enrollment_server_2_42',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=20/silver_raw_fidelis_ny_upstate_members_load_260519_b1e6.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_cenetegarisk_enrollment_server_2_42
    run_pipelines_cenetegarisk_enrollment_server_2_42 >> run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6
    create_compute >> run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6
    run_pipelines_silver_raw_fidelis_ny_upstate_members_load_260519_b1e6 >> archive_processed_files
