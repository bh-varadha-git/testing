...
common_task = CommonTask(dag_id='024_date_aliases_and_timestamps_168_181', dag_params={})
lineage_task = LineageTask(dag_id='024_date_aliases_and_timestamps_168_181', dag_params={})
...
with DAG(
    dag_id='024_date_aliases_and_timestamps_168_181',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 181,
            'flow_name': '024_date_aliases_and_timestamps_168',
            'flow_key': '024_date_aliases_and_timestamps_168',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_roster_20260906_168_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1251/roster_20260906_168.json",
                "databricks",
        ...
        "pipeline_name": "roster_20260906_168",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "roster_20260906_168",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_roster_20260906_168 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_roster_20260906_168',
    ...
    create_compute >> run_pipelines_roster_20260906_168
    run_pipelines_roster_20260906_168 >> archive_processed_files
