...
common_task = CommonTask(dag_id='local_6_49', dag_params={})
lineage_task = LineageTask(dag_id='local_6_49', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_local_6_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=48/local_6.json",
                "databricks",
    ...
    run_pipelines_local_6 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_local_6',
    ...
    create_compute >> run_pipelines_local_6
    run_pipelines_local_6 >> archive_processed_files
