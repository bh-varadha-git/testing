...
common_task = CommonTask(dag_id='025_date_aliases_and_timestamps_201_191', dag_params={})
lineage_task = LineageTask(dag_id='025_date_aliases_and_timestamps_201_191', dag_params={})
...
with DAG(
    dag_id='025_date_aliases_and_timestamps_201_191',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 191,
            'flow_name': '025_date_aliases_and_timestamps_201',
            'flow_key': '025_date_aliases_and_timestamps_201',
            'bh_project_id': 2,
            'project_name': 'local',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_roster_20260907_201_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=2/pipeline/pipeline_id=1273/roster_20260907_201.json",
                "databricks",
        ...
        "pipeline_name": "roster_20260907_201",
        "run_data_quality_rules": False,
        "dq_rules_source": "git",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "roster_20260907_201",
        "bh_project_id": 2,
        "project_id": 2,
        "project_name": "local",
    ...
    run_pipelines_roster_20260907_201 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_roster_20260907_201',
    ...
    create_compute >> run_pipelines_roster_20260907_201
    run_pipelines_roster_20260907_201 >> archive_processed_files
